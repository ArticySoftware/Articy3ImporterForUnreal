...
public:
	...
	*/
	...
	UArticyGlobalVariables* GetDefaultGlobalVariables() { return DefaultGlobalVariables; }
	void SetDefaultGlobalVariables(UArticyGlobalVariables* Globals) { DefaultGlobalVariables = Globals; }
...
protected:
	...
	/** The default global variables asset that is generated by the importer. */
	UPROPERTY(VisibleAnywhere, Category = "Articy")
	UArticyGlobalVariables* DefaultGlobalVariables;
