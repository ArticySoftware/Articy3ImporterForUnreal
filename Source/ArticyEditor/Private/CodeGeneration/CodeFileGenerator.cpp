...
void CodeFileGenerator::Variable(const FString& Type, const FString& Name, const FString& Value, const FString& Comment,
                                 const bool bUproperty, const FString& UpropertySpecifiers)
{
	if (!Comment.IsEmpty())
...
void CodeFileGenerator::StartClass(const FString& Classname, const FString& Comment, const bool bUClass,
